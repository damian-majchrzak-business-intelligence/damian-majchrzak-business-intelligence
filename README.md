...
Jestem początkującym analitykiem danych (**Analityk Danych / BI Developer**), który łączy umiejętności techniczne z biznesowym podejściem do raportowania. 

* 🛠 **Narzędzia i technologie:** Power BI, DAX, SQL (Azure SQL DB), Excel, ETL, Git / GitHub.
* 📈 **Moje podejście:** Skupiam się na czystym procesie ETL, optymalizacji modeli danych i przekładaniu surowych liczb na czytelne wnioski biznesowe.

---

### 🚀 Moje projekty w portfolio:

Poniżej znajdziesz moje najważniejsze projekty analityczne:

1. **[Enterprise Sales & Financial Performance Dashboard (Random Company)](https://github.com/damian-majchrzak-business-intelligence/RandomCompany-Sales-Financial-Dashboard)**
...
---
 ...
 📫 **Kontakt:**
* [Mój profil na LinkedIn](https://www.linkedin.com/in/dmajchrzak95/)
